            ...
            for (const std::string& a : apppaths)
            {
                if (b == a)
                {
                    if (Utils::tolowercasestring(a).find("shell") != std::string::npos) {
                        ...
                        ab.push_back("lua scripting is not supported in the linux build of this game\ndue to time constrains\n");
                        ...
                        std::vector<std::string> ab;
                        ab.push_back("fexe (dll) modding is not supported in the linux build of this game\ndue to time constrains\n");
                        Utils::PrintScreen(ab);
                        isanapprunning = false;
                        return false;
                    }
